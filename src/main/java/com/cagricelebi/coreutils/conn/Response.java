...
public class Response {
    ...
    public String toString() {
        return new StringBuilder().append("Response{error=").append(error).append(", httpResponseCode=").append(httpResponseCode).append(", httpResponseMessage=").append(httpResponseMessage).append(", output=").append(output).append("}").toString();
    }
